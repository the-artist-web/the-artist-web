...
const Page = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const res = await fetch("/the-artist-web/docs/Sliderbar-css.json");
          const data = await res.json();
          setData(data);
          setLoading(false);
        } catch (error) {
          console.error("Error Fetch Data In Css", error);
          setLoading(false);
        };
      };
    ...
    useEffect(() => {
      document.title = "css | the artist web";
